    ...
    return (
        <section className="bg-blue py-5">
            <div className="container border border-white border-wide p-5 my-3 text-white" id="quoted_rectangle">
                ...
                <p>
                    Gracias a mi amplia experiencia en diversos proyectos, he desarrollado una mirada multisistémica e interdisciplinaria que me permite conseguir éxito en cada proyecto uniendo el enfoque en los equipos y en los resultados de negocio.
                </p>
